    ...
    <section className="home">
      ...
      <div className="home-content">
        <span className="home-eyebrow">
          <span className="home-eyebrow-line" /> EVALUACIÓN SUMATIVA N°3 · INACAP 2026
        </span>
        <h1 className="home-title">
          Auditoría de Seguridad<br /><span className="home-title-accent">SaludOnline</span>
        </h1>
        ...
        <nav className="home-buttons" aria-label="Secciones del informe">
          {sections.map(s => (
            <Link key={s.to} to={s.to} className="home-btn">
